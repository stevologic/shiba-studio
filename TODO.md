...
- [x] **GitHub Actions matrix** — lint/typecheck/build/`npm test` on Ubuntu × Node 22/24, plus an audit job (`.github/workflows/ci.yml`). Windows and macOS packages are local / Luigi, not GitHub-hosted desktop runners.
