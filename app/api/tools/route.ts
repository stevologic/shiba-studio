...
const TOOL_GROUPS: Record<string, { group: string; requires?: string }> = {
  ...
  gmail_list: { group: 'Integrations', requires: 'gmail' },
  gmail_read: { group: 'Integrations', requires: 'gmail' },
  gmail_send: { group: 'Integrations', requires: 'gmail' },
  youtube_search: { group: 'Integrations', requires: 'youtube' },
  youtube_list: { group: 'Integrations', requires: 'youtube' },
  youtube_get: { group: 'Integrations', requires: 'youtube' },
  youtube_upload: { group: 'Integrations', requires: 'youtube' },
  edit_image: { group: 'AI Generation', requires: 'xai' },
  generate_video: { group: 'AI Generation', requires: 'xai' },
  ...
  reddit_read_posts: { group: 'Integrations', requires: 'reddit' },
  reddit_submit: { group: 'Integrations', requires: 'reddit' },
  ...
  talk_to_agent: { group: 'Orchestration' },
