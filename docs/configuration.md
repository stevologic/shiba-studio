...
| **Grok Bot** | Pair Grok Bot / grok.com MCP: enable, generate/rotate the `shiba_grokbot_` bearer (shown once), copy the loopback URL, plugin JSON, and `grok mcp add` command |
