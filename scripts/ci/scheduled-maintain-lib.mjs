...
export function buildMaintainPrompt(mode, extras = {}) {
  ...
  if (mode === "weekly") {
    return [
      ...
      "Keep the Windows and macOS native desktop apps (apps/) and the public packages page listed and compiling; fix app sources or site/packages.html when they drift. Do not edit .github/workflows/ — GITHUB_TOKEN cannot push workflow files.",
