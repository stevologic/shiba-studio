...
const CHAIN = [
  'verify-secure-store.ts',
  'verify-retention.ts',
  'verify-data-integrity.ts',
  'verify-cross-store-ownership.ts',
  ...
  'verify-grok-cli.ts',
  'verify-grok-cli-terminal.ts',
  'verify-cli-agent-outcome.ts',
  'verify-task-ledger.ts',
  'verify-context-engine.ts',
  'verify-chat-isolation.ts',
  'verify-chat-canonical.ts',
  'verify-chat-approvals.ts',
  'verify-agent-group-chat.ts',
  'verify-agent-avatars.ts',
  'verify-gmail.ts',
  'verify-youtube.ts',
  'verify-xai-imagine.ts',
  'verify-xai-builtin-tools.ts',
  'verify-xai-coverage.ts',
  'verify-session-lifecycle.ts',
  'verify-capability-packs.ts',
  'verify-task-checkpoints.ts',
  'verify-artifacts.ts',
  'verify-companion.ts',
  ...
  'verify-windows-publisher.ts',
  'verify-routines.ts',
  'verify-automation-guards.ts',
  'verify-background-work.ts',
  'verify-data-loading.ts',
  'verify-board-work-security.ts',
  'verify-managed-storage-integrity.ts',
  'verify-worktree-integrity.ts',
  'verify-binary-storage-integrity.ts',
  'verify-cloud-sync-integrity.ts',
  'verify-sandbox-integrity.ts',
  'verify-meetings.ts',
  'verify-live-meetings.ts',
  'verify-live-meeting-voice.ts',
  'verify-rich-cards.ts',
  'verify-stream-errors.ts',
  'verify-doctor.ts',
  'verify-harness-grants.ts',
  'verify-task-teams.ts',
  'verify-backup-restore-safety.ts',
