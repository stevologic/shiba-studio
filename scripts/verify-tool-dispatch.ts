...
async function main() {
  ...
  const tools = getToolDefinitions(
    { github: false, slack: false, googledrive: false, gmail: false, youtube: false, discord: false, x: false, reddit: false, obsidian: false, vercel: false, netlify: false } as never,
    false,
  );
